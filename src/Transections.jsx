  ...
  return (
    <div>
      <div className=' Header ps-3 pe-4 pb-2'>
        <button className='btn btn-warning mt-2' onClick={back}>Back</button>
        <h4 className=' text-center mt-2 ps-5'>Customer, <span className='text-decoration-underline'>{customer_details ? `${customer_details.name}'s` : ''}</span> Transections </h4>
